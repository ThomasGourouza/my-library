...
export const grandsEssaisEtArtDePenser: Roadmap = {
  slug: "grands-essais-et-art-de-penser",
  ...
  entries: [
    ...
    },
    {
      ...
      title: "Essais",
      note: "L'autre modèle, contemporain du premier et son contraire : phrases sentencieuses, conseils utilisables, aucune confidence. Deux manières d'occuper la même forme.",
    },
    {
      author: "Ralph Waldo Emerson",
      title: "Essais",
      note: "L'essai américain du XIXe siècle, qui parle par affirmations enchaînées plutôt que par démonstration. Il montre qu'on peut convaincre sans jamais argumenter au sens strict.",
    },
    {
      author: "Ralph Waldo Emerson",
      title: "La Confiance en soi",
      note: "Le texte le plus lu de son auteur, et l'origine lointaine d'une bonne part de la littérature américaine de développement personnel. À lire pour mesurer cette filiation.",
    },
    {
      author: "Alain",
    ...
    },
    {
      ...
      title: "Le Mythe de l'éternel retour",
      note: "Les sociétés traditionnelles décrites comme refusant l'histoire au profit d'un temps qui recommence. L'opposition qui organise toute cette section du parcours.",
    },
    {
      author: "Mircea Eliade",
      title: "Le Sacré et le Profane",
      note: "L'exposé le plus accessible de sa méthode : comment un espace ou un moment deviennent qualitativement différents des autres. À lire avant le précédent si l'on découvre l'auteur.",
    },
    {
      author: "René Guénon",
    ...
    },
    {
      ...
      note: "Deux ans d'expérience matérielle transformés en essai sur le nécessaire et le superflu. L'ouverture de la série des essais tirés d'une vie plutôt que d'une bibliothèque.",
    },
    {
      author: "Henry David Thoreau",
      title: "La Désobéissance civile",
      note: "Une nuit de prison pour refus d'impôt, et l'argument qui en sort. Le texte court dont Gandhi et King se sont réclamés : un essai qui a produit des actes.",
    },
    {
      author: "George Orwell",
      title: "Hommage à la Catalogne",
      note: "La guerre d'Espagne racontée par un combattant qui découvre que son camp ment aussi. Le modèle de l'essai qui corrige l'auteur à mesure qu'il l'écrit.",
    },
    {
      author: "Aldous Huxley",
      title: "Les Portes de la perception",
      note: "Le compte rendu méthodique d'une expérience de mescaline, mené comme une enquête sur la perception ordinaire. L'essai employé à décrire ce qui résiste au langage.",
    },
    {
      author: "Romain Gary",

...
export const leVivant: Roadmap = {
  slug: "le-vivant",
  title: "Le vivant : évolution et écologie",
  goal: "Comprendre ce qu'est un être vivant, d'où il vient et ce que nous faisons à son milieu.",
  description:
    "Deux questions structurent ce parcours : comment le vivant a pris ses formes actuelles, et ce que l'activité humaine en fait aujourd'hui. On commence par les naturalistes classiques, qui décrivent avant d'expliquer, puis par Darwin, dont la théorie a mis un siècle à être acceptée. Vient ensuite la biologie moléculaire, qui donne un mécanisme à l'hérédité, puis l'éthologie, qui applique la même méthode au comportement. La dernière partie porte sur l'écologie et le climat, où les faits scientifiques et les décisions politiques se mêlent : plusieurs positions opposées y sont représentées.",
  ageLabel: "Dès 14 ans",
  minAge: 14,
  family: "sciences",
  entries: [
    {
      ...
      note: "Trente-six volumes pour décrire la nature entière, dans une prose devenue un modèle littéraire. Buffon y suggère déjà que les espèces changent, sans oser le dire nettement.",
    },
    {
    ...
    },
    {
      ...
      note: "La biologie moléculaire tirée vers ses conséquences philosophiques : aucun projet ne préside au vivant. Un des textes scientifiques les plus discutés en France.",
    },
    {
    ...
    },
    {
      ...
      note: "Le comportement humain expliqué depuis les neurones jusqu'à l'évolution, par échelles de temps emboîtées. Le livre le plus complet sur la biologie du social.",
    },
    {
    ...
    },
    {
      ...
      note: "L'état du savoir climatique par un climatologue du MIT, en cent pages. La distinction entre ce qui est établi et ce qui reste incertain y est explicite.",
    },
    {
      author: "Steven E. Koonin",
      title: "Climat, la part d’incertitude",

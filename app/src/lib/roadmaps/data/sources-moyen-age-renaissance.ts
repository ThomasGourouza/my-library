...
export const sourcesMoyenAgeRenaissance: Roadmap = {
  slug: "sources-moyen-age-renaissance",
  title: "Aux sources : Moyen Âge et Renaissance",
  goal: "Remonter aux premiers siècles de la littérature en langue française.",
  description:
    "Cinq siècles pendant lesquels le français devient une langue littéraire, du latin d'église aux Essais de Montaigne. Le parcours suit ce mouvement : d'abord des textes collectifs et anonymes, chantés ou récités, puis l'apparition d'auteurs qui signent, enfin l'apparition d'un « je » qui se prend lui-même pour sujet. Les traductions modernes sont indispensables pour la première moitié ; c'est le prix d'entrée, et il vaut la peine d'être payé. Destiné au lecteur qui veut savoir d'où vient ce qu'il lit d'ordinaire.",
  ageLabel: "Dès 15 ans",
  minAge: 15,
  ...
  entries: [
    ...
    },
    {
      ...
      note: "Deux auteurs, deux esprits : la rêverie allégorique de Lorris, puis quarante ans plus tard l'encyclopédie sarcastique de Jean de Meung. Le livre le plus lu du Moyen Âge, et sa querelle.",
    },
    {
      author: "Anonyme (œuvre médiévale)",
      title: "Aucassin et Nicolette",
      note: "Alternance de prose et de vers chantés, et une intrigue qui retourne les rôles convenus. La légèreté médiévale, rare et précieuse dans ce corpus.",
    },
    {
      author: "Anonyme (œuvre médiévale)",
      title: "Le Roman de Renart",
      note: "La société féodale rejouée par des animaux, où le rusé l'emporte toujours sur le fort. Contrepoint indispensable à l'idéal chevaleresque des textes précédents.",
    },
    {
      author: "Anonyme (œuvre médiévale)",
    ...
    },
    {
      author: "François Villon",
      title: "Le Testament",
      note: "L'œuvre où la poésie française devient personnelle : un homme pauvre, menacé de pendaison, qui parle de sa vieillesse et de ses morts. Point de bascule du parcours.",
    },
    {
      author: "François Villon",
      title: "Ballades",
      note: "À lire après le Testament, dont elles sont détachées : la ballade des pendus et celle des dames du temps jadis suffisent à mesurer ce qu'une forme fixe permet.",
    },
    {
      author: "François Rabelais",
      title: "Pantagruel",
      note: "Le premier écrit, avant Gargantua : la farce de géants y domine encore. Le lire en premier fait sentir la progression de Rabelais vers la pensée.",
    },
    {
      author: "François Rabelais",
      title: "Gargantua",
      note: "L'éducation scolastique contre l'éducation humaniste, et l'abbaye de Thélème pour conclure. Le manifeste pédagogique de la Renaissance, sous couvert de rire.",
    },
    {
      author: "François Rabelais",
    ...
    },
    {
      ...
      title: "Les Odes",
      note: "Ronsard s'y veut le Pindare français, avec strophes savantes et mythologie dense. L'ambition d'égaler l'Antiquité en langue vulgaire, prise au sérieux.",
    },
    {
      author: "Pierre de Ronsard",
      title: "Les Amours",
      note: "Le grand recueil amoureux dans son ensemble, où l'on suit une même voix d'un livre à l'autre. À garder pour la lecture suivie plutôt que pour l'anthologie.",
    },
    {
      author: "Pierre de Ronsard",
    ...
    },
    {
      author: "Joachim du Bellay",
      title: "Les Regrets",
      note: "L'exil romain, l'ennui, les bassesses de la curie : le sonnet passe de l'idéal amoureux à la confidence quotidienne. Le sommet du recueil intime au XVIe siècle.",
    },
    {
      author: "Joachim du Bellay",
      title: "Les Antiquités de Rome",
